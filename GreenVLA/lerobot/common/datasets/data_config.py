...
class LeRobotG1DataConfig(DataConfigFactory):
    ...
    state_dim: int = 28
    control_mode: str = "joint"
    action_space_factorization: str = "Num hands: 1. Control mode: joint. Hand type: humanoid. Torso: True. Head: True."
    map_to_unified_space: bool = False
    validation_episodes: str | None = None
    return_subtasks: bool = False
    ...
    @override
    def create(self, assets_dirs: pathlib.Path, model_config: Any) -> DataConfig:
        from lerobot.common.datasets.data_transforms.robots.g1 import (
            G1InputsTransform,
            G1OutputsTransform,
        )
        ...
        # Data transforms для G1
        data_transforms = TorchGroup(
            inputs=[G1InputsTransform(action_dim=current_action_dim, 
                                      map_to_unified_space=map_to_unified_space)],
