...
def save_norm_stats(checkpoint_dir: Path, norm_stats: dict) -> None:
    ...
    for embodiment_key, norm_stats in norm_stats.items():
        # FIX: Handle None embodiment_key safely
        safe_embodiment_key = str(embodiment_key) if embodiment_key is not None else "default_robot"
        save_stats_dir = save_dir / safe_embodiment_key
